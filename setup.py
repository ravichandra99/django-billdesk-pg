...
setup(
  ...
  packages = ['django-billdesk-pg'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/ravichandra99/django-billdesk-pg/archive/refs/tags/0.1.tar.gz',    # I explain this later on
